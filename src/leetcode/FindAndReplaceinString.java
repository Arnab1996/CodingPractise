...
public class FindAndReplaceinString {
	public static void main(String[] args) {
		FindAndReplaceinString andReplaceinString = new FindAndReplaceinString();
		System.out.println(andReplaceinString.findReplaceString("abcd", new int[] { 0, 2 }, new String[] { "a", "cd" },
				new String[] { "eee", "ffff" }));
	}
